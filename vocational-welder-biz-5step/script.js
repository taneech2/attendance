...
var BMC_DATA = {
    ...
    "งานซ่อมบำรุงให้ชุมชน": {
        partners: ["อบต. / เทศบาล", "กลุ่มเกษตรกร", "วิทยาลัย (สนับสนุน)"],
        activities: ["สำรวจงานซ่อมในชุมชน", "ซ่อมเครื่องจักร ประตู หน้าต่าง", "อบรมช่างรุ่นใหม่"],
        resources: ["สมาชิกกลุ่มช่าง 5-10 คน", "เครื่องมือช่างรวมกลุ่ม", "ความเชื่อถือจากชุมชน"],
        value: ["ซ่อมถึงที่ ไม่ต้องขนไปร้าน", "ราคาย่อมเยา ช่วยชุมชน", "สร้างอาชีพให้คนในพื้นที่"],
        relations: ["เป็นลูกหลานในชุมชน ไว้ใจ", "ประชุมกลุ่มทุกเดือน", "รับงานผ่านผู้ใหญ่บ้าน"],
        channels: ["ประกาศในหมู่บ้าน", "กลุ่ม LINE ชุมชน", "ป้ายหน้า อบต."],
        customers: ["ชาวบ้านในตำบล", "เกษตรกร (ซ่อมเครื่องสูบน้ำ ฯลฯ)", "วัด / โรงเรียน"],
        costs: ["วัสดุซ่อม", "ค่าเดินทางในพื้นที่", "ค่าประกันกลุ่ม"],
        revenue: ["ค่าบริการซ่อม", "เงินสนับสนุนจาก อบต.", "ค่าอบรมช่างรุ่นใหม่"]
    }
};
