        ...
        html: `
            <div class="input-group">
                ...
                <select id="ovec-type" name="ovec-type">
                    <option value="ธุรกิจใหม่ / นวัตกรรม">1. ธุรกิจใหม่ / นวัตกรรม (สร้างสิ่งใหม่, ประดิษฐ์คิดค้น)</option>
                    <option value="ธุรกิจขายดี">2. ธุรกิจขายดี (ซื้อมาขายไป, เน้นหาสินค้าฮิต)</option>
                    <option value="สุดยอดนักขาย">3. สุดยอดนักขาย (พรีออเดอร์, นายหน้า, เน้นเทคนิคการขาย)</option>
                    <option value="ธุรกิจร่วมทุน">4. ธุรกิจร่วมทุน (จับมือกับร้านค้า/พันธมิตรภายนอก)</option>
                </select>
            </div>
            <div class="input-group">
